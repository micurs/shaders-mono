...
export const buildLights = (gpu: Gpu): LightsTransformationHandlers => {
  ...
  gpu.setAmbientLight([0.03, 0.03, 0.02, 1.0]);
  ...
  // gpu.setLight('point', 0, { pos: Point.fromValues(10, 0, 0), col: [0.6, 0.6, 0.6, 12.0] });
  // gpu.setLight('point', 1, { pos: Point.fromValues(0, 10, 0), col: [0.6, 0.6, 0.6, 12.0] });
